...
sqr1 = squared_relative_errors[2]
sqr2 = squared_relative_errors[0]
sqr3 = squared_relative_errors[1]
print(sqr1[-1], sqr2[-1], sqr3[-1])
...
fig.patch.set_facecolor('white')  # Change the background color of the entire figure
ax.set_facecolor('white')  # Change the background color of the plot
...
ax.legend(loc="upper center", bbox_to_anchor=(0.51, 0.98), ncol=3, fontsize=11.5, facecolor='white', edgecolor='black')

plt.savefig('plots/figs/report_plot.png')
plt.show()
# %%
